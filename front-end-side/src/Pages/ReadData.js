            ...
            <div class="container">
...

                {
                    delay ? (
                        <div id="statistics">
                            <div id="stat-bar">
                                <a class="stat food" href="#" style={{ width: '30%' }}><span class="text">{Math.round(data.data.foodSum / (data.data.foodSum + data.data.clothesSum + data.data.carSum + data.data.houseSum + data.data.entertaintmentSum + data.data.otherSum) * 100 * 100) / 100}%</span></a>
                                <a class="stat clothes" href="#" style={{ width: '17%' }}><span class="text">{Math.round(data.data.clothesSum / (data.data.foodSum + data.data.clothesSum + data.data.carSum + data.data.houseSum + data.data.entertaintmentSum + data.data.otherSum) * 100 * 100) / 100}%</span></a>
                                <a class="stat car" href="#" style={{ width: '18%' }}><span class="text">{Math.round(data.data.carSum / (data.data.foodSum + data.data.clothesSum + data.data.carSum + data.data.houseSum + data.data.entertaintmentSum + data.data.otherSum) * 100 * 100) / 100}%</span></a>
                                <a class="stat house" href="#" style={{ width: '25%' }}><span class="text">{Math.round(data.data.houseSum / (data.data.foodSum + data.data.clothesSum + data.data.carSum + data.data.houseSum + data.data.entertaintmentSum + data.data.otherSum) * 100 * 100) / 100}%</span></a>
                                <a class="stat entertaintment" href="#" style={{ width: '9%' }}><span class="text">{Math.round(data.data.entertaintmentSum / (data.data.foodSum + data.data.clothesSum + data.data.carSum + data.data.houseSum + data.data.entertaintmentSum + data.data.otherSum) * 100 * 100) / 100}%</span></a>
                                <a class="stat other last" href="#" style={{ width: '31%' }}><span class="text">{Math.round(data.data.otherSum / (data.data.foodSum + data.data.clothesSum + data.data.carSum + data.data.houseSum + data.data.entertaintmentSum + data.data.otherSum) * 100 * 100) / 100}%</span></a>
                            </div>
