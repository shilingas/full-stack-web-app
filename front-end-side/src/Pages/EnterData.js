...
const ShowData = () => {
    ...
    const postData = async (e) => {
        ...
        if ((!dateRegEx.test(date) && isNotEmptyRegEx.test(date)) || (!amountRegEx.test(amount) && isNotEmptyRegEx.test(amount)) || !isNotEmptyRegEx.test(details) || !isNotEmptyRegEx.test(seller) || !isNotEmptyRegEx.test(date) || !isNotEmptyRegEx.test(amount)) {
            removeErrors();

            if (!isNotEmptyRegEx.test(details) || !isNotEmptyRegEx.test(seller) || !isNotEmptyRegEx.test(date) || !isNotEmptyRegEx.test(amount)) {
                ...
                if (!isNotEmptyRegEx.test(details)) {
